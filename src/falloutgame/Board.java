...
public class Board {  
    ...
    private static ImportantArea importantareas[][] = new ImportantArea[NUM_ROWS][NUM_COLUMNS];
    ...
    public static void Reset() {
        ...
        board[3][3] = new Player_Token(Color.MAGENTA,2);
        ...
        for (int zi = 0;zi<NUM_ROWS;zi++)
            {
                for (int zx = 0;zx<NUM_COLUMNS;zx++)
                {
                   if(board[zi][zx]!=null&&board[zi][zx].getColor()==Player.getCurrentPlayer().getColor()){
                        //if(rowdir==1)
                        //newRow=board[zi][zx].move(move,zi);
                        
                        newCol=board[zi][zx].move(move,zx);
                        //currCol = ; 
                        //currRow = newRow;
                        currRow=zi;
                        currCol=zx;
